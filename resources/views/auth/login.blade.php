...
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="login-form">
                                    <div class="section-title mt-5">Log In</div>
                                    <div class="section-sub-title">Welcome Back!</div>
                                    <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                                        ...
                                        <div class="form-group text-center mt-5">
                                            <div class="text-muted">Don't Have account?</div>
                                            <a class="link" href="{{route('register')}}">Sign Up Now</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
    ...
    @include('shared.resend-verification')
